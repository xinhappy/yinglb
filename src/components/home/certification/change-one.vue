<template>
  <div>
    ...
    <div class="room">
      <div style="padding-bottom: 2vw;margin-bottom: 2vw;border-bottom: 1px solid #eee"><span>身份证</span><input
        v-model="userCard" type="text" placeholder="请输入身份证信息"></div>
      <div style="padding-bottom: 2vw;margin-bottom: 2vw;border-bottom: 1px solid #eee"><span>姓名</span><input
        v-model="userName" type="text" placeholder="请输入身份证姓名"></div>
